...
## Project Structure
- `src/app` — App Router pages and layout (sidebar + command palette). Includes Bookmarks, Tasks, Notes, Timers, Subscriptions (Finances), and Search.
...
- Sidebar includes quick access to Tasks, Notes, Timers, Bookmarks, and Finances.
